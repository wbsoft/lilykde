...
class Rational(object):
    ...
    from_exact static method.  However, because of rounding error in the
    original values, this tends to produce "ugly" fractions.  "Nicer"
    ...
    def from_exact(x):
       """
       Returns the exact Rational equivalent of x,
       where isinstance(x, (int, long, Rational, float, Decimal))
       """
       if isinstance(x, Rational):
          ...
          return Rational._from_exact_float(x)
       elif isinstance(x, _decimal.Decimal):
